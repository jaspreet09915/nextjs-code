...
const Login = () => {
  return (
    <div className=''><div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      <div>
        <img class="mx-auto h-12 w-auto" src="codeswearcircle.png" alt="Workflow"/>
        <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Sign in to your account</h2>
        <p class="mt-2 text-center text-sm text-gray-600">
          Or
         <Link href={'/signup'}><a  class="font-medium text-pink-600 hover:text-pink-500"> Signup </a></Link>
        </p>
      </div>
