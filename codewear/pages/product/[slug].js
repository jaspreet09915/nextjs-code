...
const Post = ({ buyNow,  addToCart  ,product , variants}) => {
  ...
  <div className="container px-5 py-12 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto p-0 pr-16 pl-16 object-cover object-top rounded" src={product.img}/>
...
{/* 
        ...
        <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
          <div className="flex">
            ...
            {Object.keys(variants).includes('red')&& Object.keys(variants["red"]).includes(size) && <button onClick={()=>{refreshVariant('red',size)}}  className={`border-2  ml-1 bg-red-500 rounded-full w-6 h-6 focus:outline-none ${color == "red"? "border-black" : "border-gray-300"} `}></button> }
        ...
        <div className="flex">
          ...
          <button onClick={()=>{buyNow(slug, 1, 599, product.title,  size,  color)}} className="flex ml-8 text-white bg-pink-500   border-0 py-2 px-1.5 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
          <button onClick={()=>{addToCart(slug, 1, 599, product.title,  size,  color)}} className="flex ml-4 text-white bg-pink-500   border-0 py-2 px-1.5 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
