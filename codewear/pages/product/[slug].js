...
const Post = ({ buyNow, addToCart, product, variants }) => {
  ...
  const CheckServicesability = async () => {
    ...
    if (pinJson.includes(parseInt(pin))) {
      setService(true);
      toast.success('Your Pincode is serviceale!', {
      ...
      toast.error('Your Pincode is not serviceale!', {
        position: "bottom-center",
        autoClose: 1500,
        hideProgressBar: false,
        closeOnClick: true,
      ...
      <section className="text-gray-600 body-font overflow-hidden">
        ...
        <div className="container px-5 py-12 mx-auto">
          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt="ecommerce"
              className="lg:w-1/2 w-full lg:h-auto p-0 pr-16 pl-16 object-cover object-top rounded"
              src={product.img}
            />
            ...
            <a className="text-gray-500">
              ...
              <div className="flex">
                ...
                <button
                  ...
                  className="flex ml-8 text-white bg-pink-500   border-0 py-2 px-1.5 md:px-6 focus:outline-none hover:bg-pink-600 rounded"
                >
                  Buy Now
                </button>
                <button
                  ...
                  className="flex ml-4 text-white bg-pink-500   border-0 py-2 px-1.5 md:px-6 focus:outline-none hover:bg-pink-600 rounded"
                >
                  Add to Cart
                </button>
            ...
            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
              ...
              <div className="pin mt-6 flex space-x-2">
                <input
                  ...
                  className="check px-2 border-2 border-gray-400 rounded-lg"
                  type="text"
                />
                <button
                  onClick={CheckServicesability}
                  className="  flex ml-3 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded-lg"
                >
                  Check
                </button>
              </div>
              {!service && service != null && (
                <div id="clean" className="text-red-700 text-sm mt-3">
